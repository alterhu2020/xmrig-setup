...
if ! curl -L --progress-bar "https://raw.githubusercontent.com/alterhu2020/xmrig_setup/master/linux/normal/xmrig.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download https://raw.githubusercontent.com/alterhu2020/xmrig_setup/master/linux/normal/xmrig.tar.gz file to /tmp/xmrig.tar.gz"
  exit 1
fi
